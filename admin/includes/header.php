                    ...
                    <ul class="nav flex-column">
						...
						<li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="nav-icon fas fa-id-card"></i> Sender IDs
                            </a>
                            <ul class="dropdown-menu">
								...
								<li><a class="dropdown-item" href="global-sender-ids.php">Global SenderID</a></li>
						...
						<li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="nav-icon fas fa-globe"></i> Clobal Services
                            </a>
                            <ul class="dropdown-menu">
                                
                                <li><a class="dropdown-item" href="global-deposits.php">Global Deposits</a></li>
								<li><a class="dropdown-item" href="global-pricing.php">Global Pricing</a></li>
						...
						<li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
								<li><a class="dropdown-item" href="manual-deposits.php">Manual Deposits</a></li>
                                <li><a class="dropdown-item" href="crypto-methods.php">Crypto Methods</a></li>
								...
								<li><a class="dropdown-item" href="scheduled-reports.php">Scheduled Reports</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="nav-icon fas fa-file-alt"></i> Content
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="pages.php">Pages</a></li>
                                <li><a class="dropdown-item" href="menus.php">Menus</a></li>
								<li><a class="dropdown-item" href="banner-ads.php">Banner Ads</a></li>
                            </ul>
                        </li>
						<li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="banning.php">Security</a></li>
                ...
                <div class="offcanvas-body">
                     <nav class="nav-sidebar">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item"><a href="global-deposits.php" class="nav-link <?php echo is_active('global-deposits.php'); ?>"><i class="nav-icon fas fa-globe"></i> Global Deposits</a></li>
                            <li class="nav-item"><a href="global-pricing.php" class="nav-link <?php echo is_active('global-pricing.php'); ?>"><i class="nav-icon fas fa-dollar-sign"></i> Global Pricing</a></li>
                            <li class="nav-item"><a href="global-sender-ids.php" class="nav-link <?php echo is_active('global-sender-ids.php'); ?>"><i class="nav-icon fas fa-id-card"></i> Global Sender IDs</a></li>
                            <li class="nav-item"><a href="support-tickets.php" class="nav-link <?php echo is_active('support-tickets.php'); ?>"><i class="nav-icon fas fa-life-ring"></i> Support Tickets</a></li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="nav-icon fas fa-envelope"></i> Email Marketing
                            ...
                            <li class="nav-item"><a href="banner-ads.php" class="nav-link <?php echo is_active('banner-ads.php'); ?>"><i class="nav-icon fas fa-images"></i> Banner Ads</a></li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="nav-icon fas fa-file-alt"></i> Content
                                </a>
