    ...
    const illustrations = {
        ...
        fingerprint: (
            <G>
                ...
                <Path 
                    d="M100 60c-22.1 0-40 17.9-40 40M100 70c-16.6 0-30 13.4-30 30M100 80c-11 0-20 9-20 20M100 90c-5.5 0-10 4.5-10 10" 
                    stroke={colors.primary} strokeWidth="4" strokeLinecap="round" 
                />
                <Path 
                    d="M100 60c22.1 0 40 17.9 40 40v10c0 5.5-4.5 10-10 10s-10-4.5-10-10v-10c0-11-9-20-20-20M100 70c16.6 0 30 13.4 30 30v20c0 5.5-4.5 10-10 10s-10-4.5-10-10v-10M110 110v10c0 5.5-4.5 10-10 10s-10-4.5-10-10" 
                    stroke={colors.primary} strokeWidth="4" strokeLinecap="round" 
                />
            </G>
        )
